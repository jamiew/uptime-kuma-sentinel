...
export interface ClientToServerEvents {
    login: (credentials: LoginRequest, callback: (response: SocketResponse) => void) => void;
    loginByToken: (token: string, callback: (response: SocketResponse) => void) => void;
    logout: (callback?: (response: SocketResponse) => void) => void;
    pauseMonitor: (monitorId: number, callback: (response: SocketResponse) => void) => void;
    resumeMonitor: (monitorId: number, callback: (response: SocketResponse) => void) => void;
    getMonitor: (monitorId: number, callback: (response: SocketResponse<Monitor>) => void) => void;
}
export type SentinelSocket = import("socket.io-client").Socket<ServerToClientEvents, ClientToServerEvents>;
